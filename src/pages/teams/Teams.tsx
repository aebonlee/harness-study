    ...
    <div className="guide-section">
      ...
      <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
        <svg viewBox="0 0 480 280" style={{ maxWidth: 480, width: '100%' }} role="img" aria-label={isKo ? '에이전트 팀 구조 다이어그램' : 'Agent Team Structure Diagram'}>
          ...
          <line x1="290" y1="60" x2="410" y2="100" stroke="var(--color-primary)" strokeWidth="2" markerEnd="url(#arrow-team)" />
          {/* Architect */}
          ...
          <line x1="410" y1="150" x2="310" y2="195" stroke="#ef4444" strokeWidth="2" markerEnd="url(#arrow-team)" />
          {/* Reviewer */}
