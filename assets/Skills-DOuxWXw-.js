import{u as m,r as x,j as e}from"./index-DP1gllPd.js";import{S as j}from"./SEOHead-qFDFwkum.js";import{T as r}from"./TipBox-1nhPWa9t.js";import{G as p}from"./GuideSidebar3-DYb_PjTy.js";import{B as u,S as g,R as v}from"./StarRating-hD4q7ZmY.js";const k=[{path:"/memory",icon:"fa-brain",nameKo:"메모리와 컨텍스트",nameEn:"Memory & Context",descKo:"컨텍스트 창 관리와 메모리 전략",descEn:"Context window management and memory strategies"},{path:"/patterns",icon:"fa-diagram-project",nameKo:"6가지 패턴",nameEn:"6 Patterns",descKo:"파이프라인, 팬아웃 등 아키텍처 패턴",descEn:"Pipeline, fan-out and more architecture patterns"}],n=[{id:"concept",ko:"스킬이란?",en:"What are Skills?"},{id:"disclosure",ko:"프로그레시브 디스클로저",en:"Progressive Disclosure"},{id:"structure",ko:"스킬 파일 구조",en:"Skill File Structure"},{id:"triggers",ko:"트리거 설계",en:"Trigger Design"},{id:"optimize",ko:"스킬 최적화",en:"Skill Optimization"},{id:"test",ko:"스킬 테스트",en:"Skill Testing"}],f=[{label:"스킬 기초",labelEn:"Skill Basics",items:[{id:"concept",icon:"fa-code",ko:"스킬이란?",en:"What are Skills?"},{id:"disclosure",icon:"fa-layer-group",ko:"프로그레시브 디스클로저",en:"Progressive Disclosure"}]},{label:"스킬 설계",labelEn:"Skill Design",items:[{id:"structure",icon:"fa-folder-tree",ko:"스킬 파일 구조",en:"Skill File Structure",subs:[{id:"sub-struct-method",ko:"설계 방법",en:"Design Method"},{id:"sub-struct-ex",ko:"실습 작성",en:"Practice Writing"}]},{id:"triggers",icon:"fa-bolt",ko:"트리거 설계",en:"Trigger Design",subs:[{id:"sub-trigger-method",ko:"설계 방법",en:"Design Method"},{id:"sub-trigger-ex",ko:"실습 작성",en:"Practice Writing"}]}]},{label:"최적화 & 테스트",labelEn:"Optimize & Test",items:[{id:"optimize",icon:"fa-gauge-high",ko:"스킬 최적화",en:"Skill Optimization"},{id:"test",icon:"fa-vial",ko:"스킬 테스트",en:"Skill Testing"}]}];function L(){const{language:s}=m(),[c,o]=x.useState("concept"),i=s==="ko",l=n.findIndex(a=>a.id===c),d=a=>{o(a),window.scrollTo({top:0,behavior:"smooth"})},h=a=>{setTimeout(()=>{const t=document.getElementById(a);t&&t.scrollIntoView({behavior:"smooth",block:"start"})},50)};return e.jsxs(e.Fragment,{children:[e.jsx(j,{title:i?"스킬 설계 | Harness Master":"Skill Design | Harness Master",path:"/skills"}),e.jsxs("div",{className:"guide-page",children:[e.jsx(u,{items:[{label:"따라하기",labelEn:"How-to",path:"/patterns"},{label:"스킬 설계",labelEn:"Skills"}]}),e.jsxs("div",{className:"guide-layout",children:[e.jsx(p,{groups:f,activeSection:c,onNavigate:d,onSubNavigate:h,isKo:i}),e.jsxs("main",{className:"guide-content",children:[e.jsx("div",{className:"guide-pdf-btn-wrapper",children:e.jsxs("button",{className:"guide-pdf-btn",onClick:()=>window.print(),title:i?"PDF로 저장":"Save as PDF",children:[e.jsx("i",{className:"fa-solid fa-file-pdf"}),i?"PDF 저장":"Save PDF"]})}),c==="concept"&&e.jsx(b,{isKo:i}),c==="disclosure"&&e.jsx(N,{isKo:i}),c==="structure"&&e.jsx(w,{isKo:i}),c==="triggers"&&e.jsx(S,{isKo:i}),c==="optimize"&&e.jsx(y,{isKo:i}),c==="test"&&e.jsx(T,{isKo:i}),e.jsx(g,{pageId:"skills"}),e.jsx(v,{guides:k}),e.jsxs("div",{className:"guide-section-nav",children:[e.jsxs("button",{className:"guide-nav-btn prev",onClick:()=>d(n[l-1].id),disabled:l===0,children:[e.jsx("i",{className:"fa-solid fa-arrow-left"}),e.jsxs("span",{children:[e.jsx("small",{children:i?"이전":"Prev"}),e.jsx("strong",{children:l>0?i?n[l-1].ko:n[l-1].en:""})]})]}),e.jsxs("button",{className:"guide-nav-btn next",onClick:()=>d(n[l+1].id),disabled:l===n.length-1,children:[e.jsxs("span",{children:[e.jsx("small",{children:i?"다음":"Next"}),e.jsx("strong",{children:l<n.length-1?i?n[l+1].ko:n[l+1].en:""})]}),e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]})]})]})]})}function b({isKo:s}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:s?"스킬이란?":"What are Skills?"}),e.jsx("p",{children:s?"Harness 스킬의 개념과 에이전트 효율화에서의 역할을 이해합니다.":"Understand the concept of Harness skills and their role in agent efficiency."})]}),e.jsx("h2",{children:s?"스킬의 정의":"Definition of Skills"}),e.jsx("p",{children:s?"스킬(Skill)은 에이전트가 특정 작업을 수행하기 위한 상세한 지침과 컨텍스트를 담은 파일입니다. 요리 레시피에 비유할 수 있습니다. 레시피가 요리사에게 단계별 지침을 제공하듯, 스킬은 에이전트에게 작업 수행 방법을 알려줍니다.":"A Skill is a file containing detailed instructions and context for an agent to perform a specific task. It can be compared to a cooking recipe. Just as a recipe provides step-by-step instructions to a chef, a skill tells an agent how to perform a task."}),e.jsx("h3",{children:s?"스킬의 핵심 가치":"Core Value of Skills"}),e.jsxs("div",{className:"info-grid",children:[e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"📦"}),e.jsx("h4",{children:s?"지식 캡슐화":"Knowledge Encapsulation"}),e.jsx("p",{children:s?"전문 지식을 재사용 가능한 형태로 패키징합니다.":"Packages expertise into reusable form."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"💾"}),e.jsx("h4",{children:s?"컨텍스트 절약":"Context Conservation"}),e.jsx("p",{children:s?"필요할 때만 로드되는 프로그레시브 디스클로저로 컨텍스트 창을 효율적으로 사용합니다.":"Progressive disclosure loads only when needed."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🔒"}),e.jsx("h4",{children:s?"일관성 보장":"Consistency Guarantee"}),e.jsx("p",{children:s?"동일한 스킬을 사용하면 일관된 방식으로 작업이 수행됩니다.":"Same skill ensures tasks are performed consistently."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"👥"}),e.jsx("h4",{children:s?"팀 공유 가능":"Team Shareable"}),e.jsx("p",{children:s?"잘 설계된 스킬은 팀 전체에서 공유하고 재사용할 수 있습니다.":"Well-designed skills can be shared across the entire team."})]})]}),e.jsx("h3",{children:s?"스킬 파일 최소 예시 (hello-world)":"Minimal Skill File Example (hello-world)"}),e.jsx("p",{children:s?"가장 단순한 형태의 스킬 파일입니다. 5줄로도 완전한 스킬을 만들 수 있습니다. 이 구조를 출발점으로 필요에 따라 확장하세요.":"The simplest form of a skill file. Even 5 lines can create a complete skill. Use this structure as your starting point and expand as needed."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"markdown"}),e.jsx("span",{className:"code-block-filename",children:".claude/commands/hello-world.md"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`# hello-world
