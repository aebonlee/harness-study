...
## Steps
1. Check code
2. Write review`,codeLang:"markdown"},{category:"skill",q:"스킬 파일 하나가 너무 길어지면 어떻게 하나요?",qEn:"What if a skill file gets too long?",a:"스킬 파일이 150줄을 넘어가면 분리를 고려하세요. 예를 들어 code-review.md가 너무 길면 review-security.md, review-performance.md로 나누거나, 공통 원칙은 CLAUDE.md에 이동하고 스킬 파일에는 고유한 단계만 남깁니다.",aEn:"Consider splitting if a skill file exceeds 150 lines. For example, if code-review.md gets too long, split into review-security.md and review-performance.md, or move common principles to CLAUDE.md and keep only unique steps in skill files."},{category:"skill",q:"스킬을 호출하는 방법이 여러 가지인가요?",qEn:"Are there multiple ways to invoke a skill?",a:'네. 가장 일반적인 방법은 /skill-name 슬래시 커맨드입니다. 또한 CLAUDE.md나 스킬 파일의 Trigger 섹션에 자동 활성화 조건을 정의할 수 있습니다. "코드 리뷰해줘" 같은 자연어 요청에도 Claude가 적절한 스킬을 선택할 수 있습니다.',aEn:'Yes. The most common is the /skill-name slash command. You can also define auto-activation conditions in the Trigger section of CLAUDE.md or skill files. Claude can also select appropriate skills from natural language requests like "please review this code".',codeKo:`# commands/review.md
...
Each agent returns a 3-line compressed key summary`,codeLang:"text"},{category:"etc",q:"Harness 사용 시 API 비용을 줄이는 방법은?",qEn:"How can I reduce API costs when using Harness?",a:"① 모델 계층화: 오케스트레이터 Opus, 작업 에이전트 Sonnet, 단순 작업 Haiku. ② 컨텍스트 압축: 중간 요약으로 불필요한 이력 제거. ③ 스킬 최적화: 프로그레시브 디스클로저로 스킬 파일 크기 최소화. ④ 결과 캐싱: 반복적인 연구·분석 결과를 파일에 저장해 재사용. 이 방법들을 조합하면 비용을 30-50% 절감할 수 있습니다.",aEn:"① Model tiering: Opus for orchestrator, Sonnet for task agents, Haiku for simple tasks. ② Context compression: Remove unnecessary history with intermediate summaries. ③ Skill optimization: Minimize skill file sizes via progressive disclosure. ④ Result caching: Store repetitive research results in files for reuse. Combining these can reduce costs by 30-50%."},{category:"etc",q:"에이전트가 같은 실수를 반복하면 어떻게 하나요?",qEn:"What do I do if an agent repeatedly makes the same mistake?",a:'반복 실수는 스킬 파일 지침이 불명확하다는 신호입니다. ① 해당 단계에 "절대로 ~하지 말 것" 형태의 명시적 금지사항 추가. ② 올바른 예시와 잘못된 예시를 함께 포함. ③ CLAUDE.md 전역 규칙에 반복 실수 패턴 추가. 그래도 지속되면 그 작업 단계를 더 작은 단위로 분해하세요.',aEn:'Repeated mistakes signal unclear skill file instructions. ① Add explicit prohibitions: "Never do X." ② Include both correct and incorrect examples. ③ Add the mistake pattern to CLAUDE.md global rules. If it persists, break down that task step into smaller units.'},{category:"etc",q:"CLAUDE.md가 너무 길어지면 어떻게 관리하나요?",qEn:"How do I manage CLAUDE.md when it gets too long?",a:"CLAUDE.md가 200줄을 넘으면 분리를 고려하세요. 기본 원칙(프로젝트 목적, 기술 스택, 코딩 컨벤션)만 CLAUDE.md에 유지하고, 특정 작업 지침은 commands/ 폴더의 스킬 파일로 이동합니다. docs/ 폴더에 상세 문서를 만들고 CLAUDE.md에서 @docs/guide.md 형태로 참조하는 방법도 효과적입니다.",aEn:"Consider splitting when CLAUDE.md exceeds 200 lines. Keep only fundamentals (project purpose, tech stack, conventions) in CLAUDE.md; move specific task instructions to skill files in commands/. Creating detailed docs in a docs/ folder and referencing them as @docs/guide.md in CLAUDE.md is also effective."}],g=[{id:"all",ko:"전체",en:"All",icon:"fa-border-all"},{id:"basic",ko:"기초",en:"Basics",icon:"fa-rocket"},{id:"skill",ko:"스킬",en:"Skills",icon:"fa-file-code"},{id:"team",ko:"팀 & 패턴",en:"Team & Patterns",icon:"fa-users"},{id:"etc",ko:"기타",en:"Other",icon:"fa-ellipsis"}];function v(){const{language:d}=h(),[r,m]=l.useState("all"),[n,o]=l.useState(null),a=d==="ko",u=r==="all"?i:i.filter(s=>s.category===r);return e.jsxs(e.Fragment,{children:[e.jsx(p,{title:a?"F&A | Harness Master":"FAQ | Harness Master",description:a?"Harness 학습 중 자주 묻는 질문과 답변을 모아뒀습니다.":"Frequently asked questions and answers collected from Harness learners.",path:"/community/faq"}),e.jsxs("div",{className:"community-page",children:[e.jsxs("div",{className:"community-header",children:[e.jsxs("div",{className:"guide-hero-badge",style:{display:"inline-flex",marginBottom:"1rem"},children:[e.jsx("i",{className:"fa-solid fa-circle-question"}),a?"F&A":"FAQ"]}),e.jsx("h1",{className:"community-title",children:a?"자주 묻는 질문":"Frequently Asked Questions"}),e.jsx("p",{className:"community-desc",children:a?"Harness 학습 중 자주 묻는 질문과 상세한 답변을 모아뒀습니다.":"Collected frequently asked questions with detailed answers from Harness learners."})]}),e.jsx("div",{className:"community-filter",children:g.map(s=>e.jsxs("button",{className:`community-filter-btn ${r===s.id?"active":""}`,onClick:()=>{m(s.id),o(null)},children:[e.jsx("i",{className:`fa-solid ${s.icon}`}),a?s.ko:s.en,e.jsx("span",{className:"community-filter-count",children:s.id==="all"?i.length:i.filter(t=>t.category===s.id).length})]},s.id))}),e.jsxs("div",{className:"info-grid",style:{marginBottom:"2rem"},children:[e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🚀"}),e.jsx("div",{className:"info-card-title",children:a?"기초 질문":"Basics"}),e.jsx("div",{className:"info-card-desc",children:a?"Harness의 개념, CLAUDE.md와 commands/ 차이, 오케스트레이터 역할 등 핵심 개념 질문":"Core concept questions about Harness, CLAUDE.md vs commands/, orchestrator roles"})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"📝"}),e.jsx("div",{className:"info-card-title",children:a?"스킬 설계":"Skill Design"}),e.jsx("div",{className:"info-card-desc",children:a?"스킬 파일 작성 방법, 트리거 설정, 조건 분기, 프로젝트 간 공유 등 실전 질문":"Practical questions about writing skill files, triggers, branching, and cross-project sharing"})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"👥"}),e.jsx("div",{className:"info-card-title",children:a?"팀 & 패턴":"Team & Patterns"}),e.jsx("div",{className:"info-card-desc",children:a?"멀티 에이전트 팀 구성, 패턴 선택 기준, 팬아웃 결과 취합 등 아키텍처 질문":"Architecture questions about multi-agent teams, pattern selection, and fan-out result aggregation"})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"💡"}),e.jsx("div",{className:"info-card-title",children:a?"기타 & 운영":"Other & Ops"}),e.jsx("div",{className:"info-card-desc",children:a?"팀 공유 방법, 구축 소요 시간, API 비용 절감, 반복 실수 해결 등 운영 질문":"Operational questions about team sharing, build time, API cost reduction, and fixing repeated mistakes"})]})]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(280px, 1fr))",gap:"1rem",marginBottom:"2rem"},children:[e.jsx(c,{type:"tip",children:a?"카테고리 필터를 사용하면 관심 분야의 질문만 빠르게 찾을 수 있습니다.":"Use category filters to quickly find questions in your area of interest."}),e.jsx(c,{type:"important",children:a?"코드 예제가 포함된 답변은 실제 프로젝트에 바로 적용할 수 있도록 작성되었습니다.":"Answers with code examples are written to be directly applicable to real projects."})]}),e.jsx("div",{className:"faq-list",children:u.map((s,t)=>e.jsxs("div",{className:`faq-item ${n===t?"open":""}`,children:[e.jsxs("button",{className:"faq-question",onClick:()=>o(n===t?null:t),children:[e.jsx("span",{className:"faq-q-text",children:a?s.q:s.qEn}),e.jsx("i",{className:"fa-solid fa-chevron-down faq-chevron"})]}),n===t&&e.jsxs("div",{className:"faq-answer",children:[e.jsx("p",{children:a?s.a:s.aEn}),s.codeKo&&e.jsxs("div",{className:"code-block",style:{marginTop:"1rem"},children:[e.jsx("div",{className:"code-block-header",children:e.jsx("span",{className:"code-block-lang",children:s.codeLang??"text"})}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:a?s.codeKo:s.codeEn??s.codeKo})})})]})]})]},t))})]})]})}export{v as default};
