import{u as m,r as x,j as e}from"./index-CYMN-HoY.js";import{S as u}from"./SEOHead-CTx6qKIA.js";import{T as c}from"./TipBox-CVFKZQwQ.js";import{G as g}from"./GuideSidebar3-Cpy0bCjG.js";const n=[{id:"concept",ko:"스킬이란?",en:"What are Skills?"},{id:"disclosure",ko:"프로그레시브 디스클로저",en:"Progressive Disclosure"},{id:"structure",ko:"스킬 파일 구조",en:"Skill File Structure"},{id:"triggers",ko:"트리거 설계",en:"Trigger Design"},{id:"optimize",ko:"스킬 최적화",en:"Skill Optimization"},{id:"test",ko:"스킬 테스트",en:"Skill Testing"}],p=[{label:"스킬 기초",labelEn:"Skill Basics",items:[{id:"concept",icon:"fa-code",ko:"스킬이란?",en:"What are Skills?"},{id:"disclosure",icon:"fa-layer-group",ko:"프로그레시브 디스클로저",en:"Progressive Disclosure"}]},{label:"스킬 설계",labelEn:"Skill Design",items:[{id:"structure",icon:"fa-folder-tree",ko:"스킬 파일 구조",en:"Skill File Structure",subs:[{id:"sub-struct-method",ko:"설계 방법",en:"Design Method"},{id:"sub-struct-ex",ko:"실습 작성",en:"Practice Writing"}]},{id:"triggers",icon:"fa-bolt",ko:"트리거 설계",en:"Trigger Design",subs:[{id:"sub-trigger-method",ko:"설계 방법",en:"Design Method"},{id:"sub-trigger-ex",ko:"실습 작성",en:"Practice Writing"}]}]},{label:"최적화 & 테스트",labelEn:"Optimize & Test",items:[{id:"optimize",icon:"fa-gauge-high",ko:"스킬 최적화",en:"Skill Optimization"},{id:"test",icon:"fa-vial",ko:"스킬 테스트",en:"Skill Testing"}]}];function P(){const{language:s}=m(),[r,o]=x.useState("concept"),i=s==="ko",l=n.findIndex(a=>a.id===r),t=a=>{o(a),window.scrollTo({top:0,behavior:"smooth"})},h=a=>{setTimeout(()=>{const d=document.getElementById(a);d&&d.scrollIntoView({behavior:"smooth",block:"start"})},50)};return e.jsxs(e.Fragment,{children:[e.jsx(u,{title:i?"스킬 설계 | Harness Master":"Skill Design | Harness Master",path:"/skills"}),e.jsx("div",{className:"guide-page",children:e.jsxs("div",{className:"guide-layout",children:[e.jsx(g,{groups:p,activeSection:r,onNavigate:t,onSubNavigate:h,isKo:i}),e.jsxs("main",{className:"guide-content",children:[r==="concept"&&e.jsx(j,{isKo:i}),r==="disclosure"&&e.jsx(k,{isKo:i}),r==="structure"&&e.jsx(v,{isKo:i}),r==="triggers"&&e.jsx(b,{isKo:i}),r==="optimize"&&e.jsx(f,{isKo:i}),r==="test"&&e.jsx(w,{isKo:i}),e.jsxs("div",{className:"guide-section-nav",children:[e.jsxs("button",{className:"guide-nav-btn prev",onClick:()=>t(n[l-1].id),disabled:l===0,children:[e.jsx("i",{className:"fa-solid fa-arrow-left"}),e.jsxs("span",{children:[e.jsx("small",{children:i?"이전":"Prev"}),e.jsx("strong",{children:l>0?i?n[l-1].ko:n[l-1].en:""})]})]}),e.jsxs("button",{className:"guide-nav-btn next",onClick:()=>t(n[l+1].id),disabled:l===n.length-1,children:[e.jsxs("span",{children:[e.jsx("small",{children:i?"다음":"Next"}),e.jsx("strong",{children:l<n.length-1?i?n[l+1].ko:n[l+1].en:""})]}),e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]})]})})]})}function j({isKo:s}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:s?"스킬이란?":"What are Skills?"}),e.jsx("p",{children:s?"Harness 스킬의 개념과 에이전트 효율화에서의 역할을 이해합니다.":"Understand the concept of Harness skills and their role in agent efficiency."})]}),e.jsx("h2",{children:s?"스킬의 정의":"Definition of Skills"}),e.jsx("p",{children:s?"스킬(Skill)은 에이전트가 특정 작업을 수행하기 위한 상세한 지침과 컨텍스트를 담은 파일입니다. 요리 레시피에 비유할 수 있습니다. 레시피가 요리사에게 단계별 지침을 제공하듯, 스킬은 에이전트에게 작업 수행 방법을 알려줍니다.":"A Skill is a file containing detailed instructions and context for an agent to perform a specific task. It can be compared to a cooking recipe. Just as a recipe provides step-by-step instructions to a chef, a skill tells an agent how to perform a task."}),e.jsx("h3",{children:s?"스킬의 핵심 가치":"Core Value of Skills"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:s?"지식 캡슐화":"Knowledge Encapsulation"})," — ",s?"전문 지식을 재사용 가능한 형태로 패키징합니다.":"Packages expertise into reusable form."]}),e.jsxs("li",{children:[e.jsx("strong",{children:s?"컨텍스트 절약":"Context Conservation"})," — ",s?"필요할 때만 로드되는 프로그레시브 디스클로저로 컨텍스트 창을 효율적으로 사용합니다.":"Efficiently uses context window with progressive disclosure that loads only when needed."]}),e.jsxs("li",{children:[e.jsx("strong",{children:s?"일관성 보장":"Consistency Guarantee"})," — ",s?"동일한 스킬을 사용하면 일관된 방식으로 작업이 수행됩니다.":"Using the same skill ensures tasks are performed consistently."]}),e.jsxs("li",{children:[e.jsx("strong",{children:s?"팀 공유 가능":"Team Shareable"})," — ",s?"잘 설계된 스킬은 팀 전체에서 공유하고 재사용할 수 있습니다.":"Well-designed skills can be shared and reused across the entire team."]})]}),e.jsx("h3",{children:s?"스킬 파일 최소 예시 (hello-world)":"Minimal Skill File Example (hello-world)"}),e.jsx("p",{children:s?"가장 단순한 형태의 스킬 파일입니다. 5줄로도 완전한 스킬을 만들 수 있습니다. 이 구조를 출발점으로 필요에 따라 확장하세요.":"The simplest form of a skill file. Even 5 lines can create a complete skill. Use this structure as your starting point and expand as needed."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"markdown"}),e.jsx("span",{className:"code-block-filename",children:".claude/commands/hello-world.md"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`# hello-world
...
"고쳐줘" / "fix this" / "버그가 있어" 요청 시`})})})]})]})}function f({isKo:s}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:s?"스킬 최적화":"Skill Optimization"}),e.jsx("p",{children:s?"스킬 성능을 극대화하고 컨텍스트 사용을 최소화하는 최적화 기법을 배웁니다.":"Learn optimization techniques to maximize skill performance and minimize context usage."})]}),e.jsx("h2",{children:s?"최적화 원칙":"Optimization Principles"}),e.jsxs("ol",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:s?"간결성 (Conciseness)":"Conciseness"})," — ",s?"같은 내용을 더 적은 단어로 표현하세요. 불필요한 수식어와 중복을 제거합니다.":"Express the same content with fewer words. Remove unnecessary modifiers and redundancy."]}),e.jsxs("li",{children:[e.jsx("strong",{children:s?"구조화 (Structure)":"Structure"})," — ",s?"번호 목록, 불릿 포인트, 표를 활용하여 정보를 구조화합니다.":"Use numbered lists, bullet points, and tables to structure information."]}),e.jsxs("li",{children:[e.jsx("strong",{children:s?"예시 최소화 (Minimal Examples)":"Minimal Examples"})," — ",s?"예시는 레벨 3(상세)에만 포함합니다. 핵심 지침에는 최소한의 예시만 사용합니다.":"Examples only in Level 3 (Details). Use minimal examples in core guidelines."]}),e.jsxs("li",{children:[e.jsx("strong",{children:s?"중복 제거 (No Duplication)":"No Duplication"})," — ",s?"여러 스킬에 중복되는 내용은 공통 스킬로 분리합니다.":"Content duplicated across skills should be separated into a shared skill."]})]}),e.jsx("h3",{children:s?"최적화 전/후 비교 예시":"Before/After Optimization Example"}),e.jsx("p",{children:s?"동일한 코드 리뷰 스킬을 최적화 전과 후로 비교합니다. 토큰 수를 절반으로 줄이면서 동일한 품질을 유지하는 것이 목표입니다.":"Compare the same code review skill before and after optimization. The goal is to halve the token count while maintaining the same quality."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"markdown"}),e.jsx("span",{className:"code-block-filename",children:s?"❌ 최적화 전 (비효율, ~60줄)":"❌ Before optimization (~60 lines)"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`# 코드 리뷰 스킬
...
결과:   ✅ Treatment 품질 우수, 분산 낮음`})})})]}),e.jsx(c,{type:"important",children:s?"harness-abtest 리포지토리를 활용하면 체계적인 A/B 테스트를 자동화할 수 있습니다. 새 스킬을 배포하기 전 최소 5회 이상의 비교 테스트를 권장합니다.":"Using the harness-abtest repository enables systematic A/B test automation. We recommend at least 5 comparative tests before deploying new skills."})]})}export{P as default};
