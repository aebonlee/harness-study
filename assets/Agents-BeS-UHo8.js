...
\`\`\``})})})]})]})}function p({isKo:s}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:s?"오케스트레이터":"Orchestrator"}),e.jsx("p",{children:s?"에이전트 팀의 조율자인 오케스트레이터의 역할과 동작 방식을 배웁니다.":"Learn about the role and operation of the orchestrator, the coordinator of the agent team."})]}),e.jsx("h2",{children:s?"오케스트레이터의 역할":"Orchestrator's Role"}),e.jsx("p",{children:s?"오케스트레이터는 전체 워크플로우를 관리하는 중앙 조율자입니다. 주방의 수석 셰프에 비유할 수 있습니다 — 각 요리사(에이전트)에게 레시피(스킬)와 재료를 배분하고, 모든 요리가 제시간에 완성되도록 조율합니다. 오케스트레이터 자체도 AI 에이전트이며, 보통 가장 높은 수준의 추론 능력을 가진 모델을 사용합니다.":"The orchestrator is the central coordinator managing the entire workflow. Think of the head chef in a kitchen — distributing recipes (skills) and ingredients to each cook (agent), coordinating so everything is ready on time. The orchestrator itself is an AI agent, typically using the highest reasoning capability model."}),e.jsx("h3",{children:s?"오케스트레이터의 핵심 책임":"Orchestrator's Core Responsibilities"}),e.jsxs("div",{className:"info-grid",children:[e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🔀"}),e.jsx("h4",{children:s?"작업 분해":"Task Decomposition"}),e.jsx("p",{children:s?"복잡한 작업을 에이전트가 처리할 수 있는 단위로 분해합니다.":"Breaks complex tasks into units agents can handle."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🎯"}),e.jsx("h4",{children:s?"에이전트 선택":"Agent Selection"}),e.jsx("p",{children:s?"각 서브태스크에 가장 적합한 에이전트를 선택합니다.":"Selects the most appropriate agent for each subtask."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"📊"}),e.jsx("h4",{children:s?"실행 순서 관리":"Execution Order"}),e.jsx("p",{children:s?"의존성을 고려한 최적의 실행 순서를 결정합니다.":"Determines the optimal execution order considering dependencies."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🔗"}),e.jsx("h4",{children:s?"결과 통합":"Result Integration"}),e.jsx("p",{children:s?"각 에이전트의 결과를 수집하고 통합하여 최종 산출물을 생성합니다.":"Collects and integrates each agent's results to produce the final output."})]})]}),e.jsx("div",{style:{margin:"2rem 0",textAlign:"center"},children:e.jsxs("svg",{viewBox:"0 0 460 260",style:{width:"100%",maxWidth:"460px",height:"auto"},xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("rect",{x:"155",y:"10",width:"150",height:"44",rx:"8",fill:"rgba(59,130,246,0.15)",stroke:"rgba(59,130,246,0.6)",strokeWidth:"2"}),e.jsx("text",{x:"230",y:"37",textAnchor:"middle",fontSize:"13",fill:"var(--color-primary)",fontWeight:"700",children:s?"👑 오케스트레이터":"👑 Orchestrator"}),e.jsx("line",{x1:"180",y1:"54",x2:"80",y2:"90",stroke:"var(--color-text-muted)",strokeWidth:"1.5"}),e.jsx("line",{x1:"230",y1:"54",x2:"230",y2:"90",stroke:"var(--color-text-muted)",strokeWidth:"1.5"}),e.jsx("line",{x1:"280",y1:"54",x2:"380",y2:"90",stroke:"var(--color-text-muted)",strokeWidth:"1.5"}),e.jsx("rect",{x:"20",y:"90",width:"120",height:"40",rx:"6",fill:"rgba(16,185,129,0.12)",stroke:"rgba(16,185,129,0.5)",strokeWidth:"1.5"}),e.jsx("text",{x:"80",y:"114",textAnchor:"middle",fontSize:"11",fill:"var(--color-text)",fontWeight:"600",children:s?"🔬 연구 에이전트":"🔬 Research"}),e.jsx("rect",{x:"170",y:"90",width:"120",height:"40",rx:"6",fill:"rgba(245,158,11,0.12)",stroke:"rgba(245,158,11,0.5)",strokeWidth:"1.5"}),e.jsx("text",{x:"230",y:"114",textAnchor:"middle",fontSize:"11",fill:"var(--color-text)",fontWeight:"600",children:s?"✍️ 작성 에이전트":"✍️ Writing"}),e.jsx("rect",{x:"320",y:"90",width:"120",height:"40",rx:"6",fill:"rgba(239,68,68,0.12)",stroke:"rgba(239,68,68,0.5)",strokeWidth:"1.5"}),e.jsx("text",{x:"380",y:"114",textAnchor:"middle",fontSize:"11",fill:"var(--color-text)",fontWeight:"600",children:s?"🔍 검토 에이전트":"🔍 Reviewer"}),e.jsx("line",{x1:"80",y1:"130",x2:"80",y2:"160",stroke:"var(--color-text-muted)",strokeWidth:"1",strokeDasharray:"4,3"}),e.jsx("line",{x1:"230",y1:"130",x2:"230",y2:"160",stroke:"var(--color-text-muted)",strokeWidth:"1",strokeDasharray:"4,3"}),e.jsx("line",{x1:"380",y1:"130",x2:"380",y2:"160",stroke:"var(--color-text-muted)",strokeWidth:"1",strokeDasharray:"4,3"}),e.jsx("rect",{x:"30",y:"160",width:"100",height:"28",rx:"4",fill:"var(--color-bg-secondary)",stroke:"var(--color-border)",strokeWidth:"1"}),e.jsx("text",{x:"80",y:"178",textAnchor:"middle",fontSize:"9",fill:"var(--color-text-muted)",fontFamily:"monospace",children:"research.md"}),e.jsx("rect",{x:"180",y:"160",width:"100",height:"28",rx:"4",fill:"var(--color-bg-secondary)",stroke:"var(--color-border)",strokeWidth:"1"}),e.jsx("text",{x:"230",y:"178",textAnchor:"middle",fontSize:"9",fill:"var(--color-text-muted)",fontFamily:"monospace",children:"draft.md"}),e.jsx("rect",{x:"330",y:"160",width:"100",height:"28",rx:"4",fill:"var(--color-bg-secondary)",stroke:"var(--color-border)",strokeWidth:"1"}),e.jsx("text",{x:"380",y:"178",textAnchor:"middle",fontSize:"9",fill:"var(--color-text-muted)",fontFamily:"monospace",children:"review.json"}),e.jsx("text",{x:"230",y:"220",textAnchor:"middle",fontSize:"10",fill:"var(--color-text-muted)",children:s?"오케스트레이터가 서브에이전트들에게 작업을 분배하고 결과를 수집합니다":"Orchestrator distributes tasks to subagents and collects results"})]})}),e.jsx("h3",{children:s?"오케스트레이터 CLAUDE.md 최소 예시":"Minimal Orchestrator CLAUDE.md Example"}),e.jsx("p",{children:s?"아래는 가장 간단한 형태의 오케스트레이터 파일입니다. Role과 Workflow 두 섹션만으로 에이전트 팀을 조율하는 최소 구조입니다.":"Below is the simplest form of an orchestrator file. A minimal structure coordinating an agent team with just two sections: Role and Workflow."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"markdown"}),e.jsx("span",{className:"code-block-filename",children:".claude/CLAUDE.md (최소 오케스트레이터)"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`# 오케스트레이터
