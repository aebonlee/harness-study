...
- Retry 3 times on error, then report to user`})})})]})]})]})}),e.jsx("section",{className:"section cta-section",children:e.jsxs("div",{className:"container",style:{textAlign:"center"},children:[e.jsx("h2",{className:"cta-title",children:s?"지금 바로 시작하세요":"Start Right Now"}),e.jsx("p",{className:"cta-subtitle",style:{marginBottom:"2rem"},children:s?"기초 개념부터 실전 구축까지, Harness Master와 함께합니다.":"From basics to real-world implementation — Harness Master is with you."}),e.jsxs("div",{className:"cta-actions",children:[e.jsxs(o,{to:"/intro",className:"btn btn-primary btn-lg",children:[e.jsx("i",{className:"fa-solid fa-rocket"}),s?"기본학습 시작":"Start Basics"]}),e.jsxs(o,{to:"/build",className:"btn btn-outline btn-lg",children:[e.jsx("i",{className:"fa-solid fa-hammer"}),s?"구축 가이드":"Build Guide"]})]})]})})]})}export{u as default};
