import{u as p,r as x,j as e}from"./index-DP1gllPd.js";import{S as m}from"./SEOHead-qFDFwkum.js";import{T as i}from"./TipBox-1nhPWa9t.js";import{G as u}from"./GuideSidebar3-DYb_PjTy.js";import{B as j,S as g,R as f}from"./StarRating-hD4q7ZmY.js";const v=[{path:"/agents",icon:"fa-robot",nameKo:"에이전트 이해",nameEn:"Agents",descKo:"에이전트 역할과 오케스트레이터 구조",descEn:"Agent roles and orchestrator structure"},{path:"/teams",icon:"fa-users",nameKo:"팀 구성",nameEn:"Team Building",descKo:"효과적인 에이전트 팀 설계 원칙",descEn:"Effective agent team design principles"},{path:"/practice",icon:"fa-flask",nameKo:"실전 활용",nameEn:"Practice",descKo:"실전 프로젝트에서 패턴 적용 사례",descEn:"Pattern application in real projects"}],n=[{id:"pipeline",ko:"파이프라인 패턴",en:"Pipeline"},{id:"fanout",ko:"팬아웃/팬인",en:"Fan-out/Fan-in"},{id:"expert",ko:"전문가 풀",en:"Expert Pool"},{id:"producer",ko:"생산자-검토자",en:"Producer-Reviewer"},{id:"supervisor",ko:"감독자 패턴",en:"Supervisor"},{id:"hierarchical",ko:"계층적 위임",en:"Hierarchical Delegation"}],y=[{label:"기본 패턴",labelEn:"Basic Patterns",items:[{id:"pipeline",icon:"fa-arrow-right-long",ko:"파이프라인 패턴",en:"Pipeline",subs:[{id:"sub-pipeline-struct",ko:"패턴 구조",en:"Structure"},{id:"sub-pipeline-cases",ko:"적용 시나리오",en:"Scenarios"},{id:"sub-pipeline-ex",ko:"실습 예제",en:"Practice"}]},{id:"fanout",icon:"fa-code-fork",ko:"팬아웃/팬인",en:"Fan-out/Fan-in",subs:[{id:"sub-fanout-struct",ko:"패턴 구조",en:"Structure"},{id:"sub-fanout-cases",ko:"적용 시나리오",en:"Scenarios"},{id:"sub-fanout-ex",ko:"실습 예제",en:"Practice"}]}]},{label:"전문가 패턴",labelEn:"Advanced Patterns",items:[{id:"expert",icon:"fa-user-tie",ko:"전문가 풀",en:"Expert Pool"},{id:"producer",icon:"fa-pen-to-square",ko:"생산자-검토자",en:"Producer-Reviewer"}]},{label:"계층 패턴",labelEn:"Hierarchical",items:[{id:"supervisor",icon:"fa-eye",ko:"감독자 패턴",en:"Supervisor"},{id:"hierarchical",icon:"fa-sitemap",ko:"계층적 위임",en:"Hierarchical Delegation"}]}];function C(){const{language:r}=p(),[a,o]=x.useState("pipeline"),s=r==="ko",t=n.findIndex(c=>c.id===a),l=c=>{o(c),window.scrollTo({top:0,behavior:"smooth"})},h=c=>{setTimeout(()=>{const d=document.getElementById(c);d&&d.scrollIntoView({behavior:"smooth",block:"start"})},50)};return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:s?"6가지 아키텍처 패턴 | Harness Master":"6 Architectural Patterns | Harness Master",path:"/patterns"}),e.jsxs("div",{className:"guide-page",children:[e.jsx(j,{items:[{label:"따라하기",labelEn:"How-to",path:"/patterns"},{label:"패턴",labelEn:"Patterns"}]}),e.jsxs("div",{className:"guide-layout",children:[e.jsx(u,{groups:y,activeSection:a,onNavigate:l,onSubNavigate:h,isKo:s}),e.jsxs("main",{className:"guide-content",children:[e.jsx("div",{className:"guide-pdf-btn-wrapper",children:e.jsxs("button",{className:"guide-pdf-btn",onClick:()=>window.print(),title:s?"PDF로 저장":"Save as PDF",children:[e.jsx("i",{className:"fa-solid fa-file-pdf"}),s?"PDF 저장":"Save PDF"]})}),a==="pipeline"&&e.jsx(k,{isKo:s}),a==="fanout"&&e.jsx(b,{isKo:s}),a==="expert"&&e.jsx(N,{isKo:s}),a==="producer"&&e.jsx(w,{isKo:s}),a==="supervisor"&&e.jsx(A,{isKo:s}),a==="hierarchical"&&e.jsx(S,{isKo:s}),e.jsx(g,{pageId:"patterns"}),e.jsx(f,{guides:v}),e.jsxs("div",{className:"guide-section-nav",children:[e.jsxs("button",{className:"guide-nav-btn prev",onClick:()=>l(n[t-1].id),disabled:t===0,children:[e.jsx("i",{className:"fa-solid fa-arrow-left"}),e.jsxs("span",{children:[e.jsx("small",{children:s?"이전":"Prev"}),e.jsx("strong",{children:t>0?s?n[t-1].ko:n[t-1].en:""})]})]}),e.jsxs("button",{className:"guide-nav-btn next",onClick:()=>l(n[t+1].id),disabled:t===n.length-1,children:[e.jsxs("span",{children:[e.jsx("small",{children:s?"다음":"Next"}),e.jsx("strong",{children:t<n.length-1?s?n[t+1].ko:n[t+1].en:""})]}),e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]})]})]})]})}function k({isKo:r}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:r?"파이프라인 패턴":"Pipeline Pattern"}),e.jsx("p",{children:r?"에이전트들이 순차적으로 작업을 처리하는 가장 기본적인 패턴입니다.":"The most fundamental pattern where agents process tasks sequentially."})]}),e.jsx("h2",{id:"sub-pipeline-struct",children:r?"패턴 구조":"Pattern Structure"}),e.jsx("p",{children:r?"파이프라인 패턴에서는 에이전트 A의 출력이 에이전트 B의 입력이 되고, 에이전트 B의 출력이 에이전트 C의 입력이 되는 방식으로 연속적으로 처리됩니다. 제조 공장의 조립 라인과 같습니다.":"In the pipeline pattern, Agent A's output becomes Agent B's input, Agent B's output becomes Agent C's input, and so on. Like an assembly line in a factory."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"text"}),e.jsx("span",{className:"code-block-filename",children:r?"파이프라인 흐름도":"Pipeline Flow"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`입력(Input)
   │
   ▼
┌─────────────────┐
│  연구 에이전트   │  웹 검색, 문서 분석
...
※ 각 관리자는 자신의 팀에 팬아웃 패턴을 적용하여 병렬 처리`})})})]}),e.jsx(i,{type:"tip",children:r?"계층적 위임 패턴은 팬아웃 패턴과 결합하면 매우 강력합니다. 중간 관리자 계층에서 팬아웃을 사용하여 병렬 처리를 극대화할 수 있습니다.":"Hierarchical delegation combined with the fan-out pattern is very powerful. Using fan-out at the middle manager layer maximizes parallel processing."})]})}export{C as default};
