import{u as p,r as x,j as e}from"./index-kHmb9TRR.js";import{S as m}from"./SEOHead-CyjcIpua.js";import{T as t}from"./TipBox-e5C4aiyP.js";import{G as u}from"./GuideSidebar3-0cxK9ojO.js";const n=[{id:"pipeline",ko:"파이프라인 패턴",en:"Pipeline"},{id:"fanout",ko:"팬아웃/팬인",en:"Fan-out/Fan-in"},{id:"expert",ko:"전문가 풀",en:"Expert Pool"},{id:"producer",ko:"생산자-검토자",en:"Producer-Reviewer"},{id:"supervisor",ko:"감독자 패턴",en:"Supervisor"},{id:"hierarchical",ko:"계층적 위임",en:"Hierarchical Delegation"}],j=[{label:"기본 패턴",labelEn:"Basic Patterns",items:[{id:"pipeline",icon:"fa-arrow-right-long",ko:"파이프라인 패턴",en:"Pipeline",subs:[{id:"sub-pipeline-struct",ko:"패턴 구조",en:"Structure"},{id:"sub-pipeline-cases",ko:"적용 시나리오",en:"Scenarios"},{id:"sub-pipeline-ex",ko:"실습 예제",en:"Practice"}]},{id:"fanout",icon:"fa-code-fork",ko:"팬아웃/팬인",en:"Fan-out/Fan-in",subs:[{id:"sub-fanout-struct",ko:"패턴 구조",en:"Structure"},{id:"sub-fanout-cases",ko:"적용 시나리오",en:"Scenarios"},{id:"sub-fanout-ex",ko:"실습 예제",en:"Practice"}]}]},{label:"전문가 패턴",labelEn:"Advanced Patterns",items:[{id:"expert",icon:"fa-user-tie",ko:"전문가 풀",en:"Expert Pool"},{id:"producer",icon:"fa-pen-to-square",ko:"생산자-검토자",en:"Producer-Reviewer"}]},{label:"계층 패턴",labelEn:"Hierarchical",items:[{id:"supervisor",icon:"fa-eye",ko:"감독자 패턴",en:"Supervisor"},{id:"hierarchical",icon:"fa-sitemap",ko:"계층적 위임",en:"Hierarchical Delegation"}]}];function P(){const{language:r}=p(),[a,o]=x.useState("pipeline"),s=r==="ko",i=n.findIndex(c=>c.id===a),l=c=>{o(c),window.scrollTo({top:0,behavior:"smooth"})},h=c=>{setTimeout(()=>{const d=document.getElementById(c);d&&d.scrollIntoView({behavior:"smooth",block:"start"})},50)};return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:s?"6가지 아키텍처 패턴 | Harness Master":"6 Architectural Patterns | Harness Master",path:"/patterns"}),e.jsx("div",{className:"guide-page",children:e.jsxs("div",{className:"guide-layout",children:[e.jsx(u,{groups:j,activeSection:a,onNavigate:l,onSubNavigate:h,isKo:s}),e.jsxs("main",{className:"guide-content",children:[a==="pipeline"&&e.jsx(g,{isKo:s}),a==="fanout"&&e.jsx(f,{isKo:s}),a==="expert"&&e.jsx(v,{isKo:s}),a==="producer"&&e.jsx(y,{isKo:s}),a==="supervisor"&&e.jsx(k,{isKo:s}),a==="hierarchical"&&e.jsx(b,{isKo:s}),e.jsxs("div",{className:"guide-section-nav",children:[e.jsxs("button",{className:"guide-nav-btn prev",onClick:()=>l(n[i-1].id),disabled:i===0,children:[e.jsx("i",{className:"fa-solid fa-arrow-left"}),e.jsxs("span",{children:[e.jsx("small",{children:s?"이전":"Prev"}),e.jsx("strong",{children:i>0?s?n[i-1].ko:n[i-1].en:""})]})]}),e.jsxs("button",{className:"guide-nav-btn next",onClick:()=>l(n[i+1].id),disabled:i===n.length-1,children:[e.jsxs("span",{children:[e.jsx("small",{children:s?"다음":"Next"}),e.jsx("strong",{children:i<n.length-1?s?n[i+1].ko:n[i+1].en:""})]}),e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]})]})})]})}function g({isKo:r}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:r?"파이프라인 패턴":"Pipeline Pattern"}),e.jsx("p",{children:r?"에이전트들이 순차적으로 작업을 처리하는 가장 기본적인 패턴입니다.":"The most fundamental pattern where agents process tasks sequentially."})]}),e.jsx("h2",{id:"sub-pipeline-struct",children:r?"패턴 구조":"Pattern Structure"}),e.jsx("p",{children:r?"파이프라인 패턴에서는 에이전트 A의 출력이 에이전트 B의 입력이 되고, 에이전트 B의 출력이 에이전트 C의 입력이 되는 방식으로 연속적으로 처리됩니다. 제조 공장의 조립 라인과 같습니다.":"In the pipeline pattern, Agent A's output becomes Agent B's input, Agent B's output becomes Agent C's input, and so on. Like an assembly line in a factory."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"text"}),e.jsx("span",{className:"code-block-filename",children:r?"파이프라인 흐름도":"Pipeline Flow"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`입력(Input)
   │
   ▼
┌─────────────────┐
│  연구 에이전트   │  웹 검색, 문서 분석
...
※ 각 관리자는 자신의 팀에 팬아웃 패턴을 적용하여 병렬 처리`})})})]}),e.jsx(t,{type:"tip",children:r?"계층적 위임 패턴은 팬아웃 패턴과 결합하면 매우 강력합니다. 중간 관리자 계층에서 팬아웃을 사용하여 병렬 처리를 극대화할 수 있습니다.":"Hierarchical delegation combined with the fan-out pattern is very powerful. Using fan-out at the middle manager layer maximizes parallel processing."})]})}export{P as default};
