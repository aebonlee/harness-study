import{u as p,r as u,j as e}from"./index-CYMN-HoY.js";import{S as x}from"./SEOHead-CTx6qKIA.js";import{T as i}from"./TipBox-CVFKZQwQ.js";import{G as m}from"./GuideSidebar3-Cpy0bCjG.js";const t=[{id:"pipeline",ko:"파이프라인 패턴",en:"Pipeline"},{id:"fanout",ko:"팬아웃/팬인",en:"Fan-out/Fan-in"},{id:"expert",ko:"전문가 풀",en:"Expert Pool"},{id:"producer",ko:"생산자-검토자",en:"Producer-Reviewer"},{id:"supervisor",ko:"감독자 패턴",en:"Supervisor"},{id:"hierarchical",ko:"계층적 위임",en:"Hierarchical Delegation"}],g=[{label:"기본 패턴",labelEn:"Basic Patterns",items:[{id:"pipeline",icon:"fa-arrow-right-long",ko:"파이프라인 패턴",en:"Pipeline",subs:[{id:"sub-pipeline-struct",ko:"패턴 구조",en:"Structure"},{id:"sub-pipeline-cases",ko:"적용 시나리오",en:"Scenarios"},{id:"sub-pipeline-ex",ko:"실습 예제",en:"Practice"}]},{id:"fanout",icon:"fa-code-fork",ko:"팬아웃/팬인",en:"Fan-out/Fan-in",subs:[{id:"sub-fanout-struct",ko:"패턴 구조",en:"Structure"},{id:"sub-fanout-cases",ko:"적용 시나리오",en:"Scenarios"},{id:"sub-fanout-ex",ko:"실습 예제",en:"Practice"}]}]},{label:"전문가 패턴",labelEn:"Advanced Patterns",items:[{id:"expert",icon:"fa-user-tie",ko:"전문가 풀",en:"Expert Pool"},{id:"producer",icon:"fa-pen-to-square",ko:"생산자-검토자",en:"Producer-Reviewer"}]},{label:"계층 패턴",labelEn:"Hierarchical",items:[{id:"supervisor",icon:"fa-eye",ko:"감독자 패턴",en:"Supervisor"},{id:"hierarchical",icon:"fa-sitemap",ko:"계층적 위임",en:"Hierarchical Delegation"}]}];function P(){const{language:r}=p(),[a,o]=u.useState("pipeline"),s=r==="ko",n=t.findIndex(l=>l.id===a),c=l=>{o(l),window.scrollTo({top:0,behavior:"smooth"})},h=l=>{setTimeout(()=>{const d=document.getElementById(l);d&&d.scrollIntoView({behavior:"smooth",block:"start"})},50)};return e.jsxs(e.Fragment,{children:[e.jsx(x,{title:s?"6가지 아키텍처 패턴 | Harness Master":"6 Architectural Patterns | Harness Master",path:"/patterns"}),e.jsx("div",{className:"guide-page",children:e.jsxs("div",{className:"guide-layout",children:[e.jsx(m,{groups:g,activeSection:a,onNavigate:c,onSubNavigate:h,isKo:s}),e.jsxs("main",{className:"guide-content",children:[a==="pipeline"&&e.jsx(j,{isKo:s}),a==="fanout"&&e.jsx(v,{isKo:s}),a==="expert"&&e.jsx(k,{isKo:s}),a==="producer"&&e.jsx(b,{isKo:s}),a==="supervisor"&&e.jsx(f,{isKo:s}),a==="hierarchical"&&e.jsx(y,{isKo:s}),e.jsxs("div",{className:"guide-section-nav",children:[e.jsxs("button",{className:"guide-nav-btn prev",onClick:()=>c(t[n-1].id),disabled:n===0,children:[e.jsx("i",{className:"fa-solid fa-arrow-left"}),e.jsxs("span",{children:[e.jsx("small",{children:s?"이전":"Prev"}),e.jsx("strong",{children:n>0?s?t[n-1].ko:t[n-1].en:""})]})]}),e.jsxs("button",{className:"guide-nav-btn next",onClick:()=>c(t[n+1].id),disabled:n===t.length-1,children:[e.jsxs("span",{children:[e.jsx("small",{children:s?"다음":"Next"}),e.jsx("strong",{children:n<t.length-1?s?t[n+1].ko:t[n+1].en:""})]}),e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]})]})})]})}function j({isKo:r}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:r?"파이프라인 패턴":"Pipeline Pattern"}),e.jsx("p",{children:r?"에이전트들이 순차적으로 작업을 처리하는 가장 기본적인 패턴입니다.":"The most fundamental pattern where agents process tasks sequentially."})]}),e.jsx("h2",{id:"sub-pipeline-struct",children:r?"패턴 구조":"Pattern Structure"}),e.jsx("p",{children:r?"파이프라인 패턴에서는 에이전트 A의 출력이 에이전트 B의 입력이 되고, 에이전트 B의 출력이 에이전트 C의 입력이 되는 방식으로 연속적으로 처리됩니다. 제조 공장의 조립 라인과 같습니다.":"In the pipeline pattern, Agent A's output becomes Agent B's input, Agent B's output becomes Agent C's input, and so on. Like an assembly line in a factory."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"text"}),e.jsx("span",{className:"code-block-filename",children:r?"파이프라인 흐름도":"Pipeline Flow"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`입력(Input)
   │
   ▼
┌─────────────────┐
│  연구 에이전트   │  웹 검색, 문서 분석
...
- Task (서브에이전트 실행)`})})})]})]})}function v({isKo:r}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:r?"팬아웃/팬인 패턴":"Fan-out/Fan-in Pattern"}),e.jsx("p",{children:r?"하나의 작업을 여러 에이전트에게 분배하고 결과를 통합하는 병렬 처리 패턴입니다.":"A parallel processing pattern that distributes one task to multiple agents and integrates results."})]}),e.jsx("h2",{id:"sub-fanout-struct",children:r?"패턴 구조":"Pattern Structure"}),e.jsx("p",{children:r?"팬아웃 단계에서 오케스트레이터가 작업을 여러 병렬 에이전트에게 분배합니다. 각 에이전트는 독립적으로 작업을 처리하고, 팬인 단계에서 오케스트레이터가 모든 결과를 수집하여 통합합니다.":"In the fan-out phase, the orchestrator distributes tasks to multiple parallel agents. Each agent processes independently, and in the fan-in phase, the orchestrator collects and integrates all results."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"text"}),e.jsx("span",{className:"code-block-filename",children:r?"팬아웃/팬인 흐름도":"Fan-out/Fan-in Flow"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`               입력(Input)
         ...
         └──┬───┘└──┬───┘└──┬───┘
          ...
          └─────────────────┘
                    │
                    ▼
               최종 산출물`})})})]}),e.jsx("h3",{id:"sub-fanout-cases",children:r?"적용 시나리오":"Application Scenarios"}),e.jsxs("ul",{children:[e.jsx("li",{children:r?"다국어 번역 (동시에 여러 언어로 번역)":"Multi-language translation (simultaneously translate to multiple languages)"}),e.jsx("li",{children:r?"여러 소스에서 정보 수집 후 통합":"Information gathering from multiple sources then integration"}),e.jsx("li",{children:r?"코드베이스의 여러 모듈 동시 분석":"Simultaneous analysis of multiple codebase modules"})]}),e.jsx(i,{type:"important",children:r?"팬아웃 단계에서 분배되는 작업은 서로 독립적이어야 합니다. 작업 간 의존성이 있다면 파이프라인 패턴이 더 적합합니다.":"Tasks distributed in the fan-out phase should be independent of each other. If there are dependencies, the pipeline pattern is more appropriate."}),e.jsx("h3",{id:"sub-fanout-ex",children:r?"실습 예제 — 다국어 문서 생성":"Practice Example — Multi-language Document Generation"}),e.jsx("p",{children:r?"3개 언어(한국어·영어·일본어)로 동시 번역하는 팬아웃 패턴 예시입니다. 각 번역 에이전트가 병렬로 실행됩니다.":"A fan-out example that translates to 3 languages (Korean, English, Japanese) simultaneously. Each translation agent runs in parallel."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"markdown"}),e.jsx("span",{className:"code-block-filename",children:".claude/commands/translate-all.md"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`# translate-all (팬아웃 패턴)
## Trigger
...
## Tools
- Task (서브에이전트 실행)
- Read / Write`})})})]})]})}function k({isKo:r}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:r?"전문가 풀 패턴":"Expert Pool Pattern"}),e.jsx("p",{children:r?"다양한 전문가 에이전트 풀에서 작업에 맞는 전문가를 동적으로 선택하는 패턴입니다.":"A pattern that dynamically selects the right specialist from a pool of diverse expert agents."})]}),e.jsx("h2",{children:r?"패턴 구조":"Pattern Structure"}),e.jsx("p",{children:r?"오케스트레이터는 다양한 전문 에이전트(파이썬 전문가, 보안 전문가, DB 전문가 등)를 풀로 유지합니다. 작업이 들어오면 해당 작업에 가장 적합한 전문가를 선택하여 처리를 위임합니다.":"The orchestrator maintains a pool of diverse specialist agents (Python specialist, Security specialist, DB specialist, etc.). When a task arrives, it selects the most appropriate specialist and delegates the processing."}),e.jsx("h3",{children:r?"적용 시나리오":"Application Scenarios"}),e.jsxs("ul",{children:[e.jsx("li",{children:r?"다양한 기술 스택을 다루는 코드 리뷰 시스템":"Code review system handling diverse tech stacks"}),e.jsx("li",{children:r?"고객 문의를 담당 부서에 라우팅하는 지원 시스템":"Support system routing customer queries to responsible departments"}),e.jsx("li",{children:r?"문서 유형에 따른 전문 처리 (법률/기술/마케팅 문서)":"Specialized processing by document type (legal/technical/marketing)"})]}),e.jsx("h3",{children:r?"전문가 풀 라우팅 예시":"Expert Pool Routing Example"}),e.jsx("p",{children:r?"코드 리뷰 요청이 들어오면 오케스트레이터가 파일 확장자를 보고 적합한 전문가에게 자동 라우팅합니다.":"When a code review request comes in, the orchestrator reads the file extension and auto-routes to the appropriate specialist."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"markdown"}),e.jsx("span",{className:"code-block-filename",children:".claude/CLAUDE.md (전문가 풀 오케스트레이터)"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`# 코드 리뷰 전문가 풀 오케스트레이터
...
5. security-expert는 항상 실행한다 (모든 변경사항 대상)`})})})]}),e.jsx(i,{type:"tip",children:r?"전문가 풀의 각 에이전트는 자신의 전문 영역을 명확히 정의한 프로필을 가져야 합니다. 오케스트레이터가 이 프로필을 기반으로 최적의 에이전트를 선택합니다.":"Each agent in the expert pool should have a clearly defined profile of their specialty. The orchestrator selects the optimal agent based on this profile."})]})}function b({isKo:r}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:r?"생산자-검토자 패턴":"Producer-Reviewer Pattern"}),e.jsx("p",{children:r?"생산 에이전트가 산출물을 만들고, 검토 에이전트가 품질을 보장하는 패턴입니다.":"A pattern where a producer agent creates outputs and a reviewer agent ensures quality."})]}),e.jsx("h2",{children:r?"패턴 구조":"Pattern Structure"}),e.jsx("p",{children:r?"생산자(Producer) 에이전트가 초안이나 코드를 작성합니다. 검토자(Reviewer) 에이전트가 이를 평가하고 피드백을 제공합니다. 필요한 경우 생산자가 수정하고 재검토를 요청합니다. 이 사이클이 반복되어 최종 고품질 산출물이 만들어집니다.":"The Producer agent writes drafts or code. The Reviewer agent evaluates and provides feedback. The producer revises and requests re-review if needed. This cycle repeats until a final high-quality output is produced."}),e.jsx("h3",{children:r?"효과적인 검토 기준 설정":"Setting Effective Review Criteria"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:r?"명확성":"Clarity"})," — ",r?"검토자가 무엇을 평가해야 하는지 명확히 정의":"Clearly define what the reviewer should evaluate"]}),e.jsxs("li",{children:[e.jsx("strong",{children:r?"구체성":"Specificity"})," — ",r?'추상적인 "좋음/나쁨" 대신 구체적인 기준 제시':'Specific criteria instead of abstract "good/bad"']}),e.jsxs("li",{children:[e.jsx("strong",{children:r?"실행 가능성":"Actionability"})," — ",r?"피드백이 구체적인 개선 행동으로 이어질 수 있어야 함":"Feedback should lead to concrete improvement actions"]})]}),e.jsx("h3",{children:r?"생산자-검토자 재시도 사이클 예시":"Producer-Reviewer Retry Cycle Example"}),e.jsx("p",{children:r?"검토자가 점수를 낮게 주면 생산자에게 재작업을 요청하는 사이클 구조입니다. 최대 3회 반복 후 최종 결과를 반환합니다.":"A cycle where the reviewer requests rework from the producer for low scores. Returns final result after max 3 iterations."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"markdown"}),e.jsx("span",{className:"code-block-filename",children:".claude/CLAUDE.md (생산자-검토자 오케스트레이터)"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`# 생산자-검토자 오케스트레이터
...
3. output/final.md 저장 + 리뷰 이력 output/review-log.json에 기록`})})})]}),e.jsx(i,{type:"important",children:r?"생산자-검토자 패턴은 Harness A/B 테스트에서 가장 큰 품질 개선을 보인 패턴입니다. 특히 코드 품질과 문서 완성도 측면에서 탁월한 효과를 발휘합니다.":"The Producer-Reviewer pattern showed the largest quality improvement in Harness A/B tests, especially in code quality and documentation completeness."})]})}function f({isKo:r}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:r?"감독자 패턴":"Supervisor Pattern"}),e.jsx("p",{children:r?"상위 감독자 에이전트가 여러 작업자 에이전트를 실시간으로 모니터링하고 개입하는 패턴입니다.":"A pattern where a supervisor agent monitors and intervenes with multiple worker agents in real-time."})]}),e.jsx("h2",{children:r?"패턴 구조":"Pattern Structure"}),e.jsx("p",{children:r?"감독자(Supervisor) 에이전트는 여러 작업자(Worker) 에이전트를 모니터링합니다. 작업자가 오류를 만나거나 도움이 필요할 때 감독자가 개입합니다. 감독자는 또한 작업의 우선순위를 동적으로 조정할 수 있습니다.":"The Supervisor agent monitors multiple Worker agents. When workers encounter errors or need help, the supervisor intervenes. The supervisor can also dynamically adjust task priorities."}),e.jsx("h3",{children:r?"적용 시나리오":"Application Scenarios"}),e.jsxs("ul",{children:[e.jsx("li",{children:r?"장시간 실행되는 복잡한 작업의 모니터링":"Monitoring long-running complex tasks"}),e.jsx("li",{children:r?"오류 복구가 중요한 미션 크리티컬 워크플로우":"Mission-critical workflows where error recovery is important"}),e.jsx("li",{children:r?"동적으로 우선순위가 변경되는 작업 환경":"Task environments where priorities change dynamically"})]}),e.jsx("h3",{children:r?"감독자 모니터링 상태 파일 예시":"Supervisor Monitoring State File Example"}),e.jsx("p",{children:r?"감독자 에이전트가 작업자들의 상태를 주기적으로 기록하는 파일입니다. 이상 감지 시 자동 개입 트리거로 활용합니다.":"A file where the supervisor agent periodically records worker status. Used as an auto-intervention trigger on anomaly detection."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"json"}),e.jsx("span",{className:"code-block-filename",children:"tmp/supervisor-state.json"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`{
...
※ 각 관리자는 자신의 팀에 팬아웃 패턴을 적용하여 병렬 처리`})})})]}),e.jsx(i,{type:"tip",children:r?"계층적 위임 패턴은 팬아웃 패턴과 결합하면 매우 강력합니다. 중간 관리자 계층에서 팬아웃을 사용하여 병렬 처리를 극대화할 수 있습니다.":"Hierarchical delegation combined with the fan-out pattern is very powerful. Using fan-out at the middle manager layer maximizes parallel processing."})]})}export{P as default};
