import{u as o,r as h,j as e}from"./index-DP1gllPd.js";import{S as m}from"./SEOHead-qFDFwkum.js";import{T as r}from"./TipBox-1nhPWa9t.js";import{G as x}from"./GuideSidebar3-DYb_PjTy.js";import{B as j,S as p,R as u}from"./StarRating-hD4q7ZmY.js";const v=[{path:"/teams",icon:"fa-users",nameKo:"팀 구성",nameEn:"Team Building",descKo:"에이전트 팀 설계와 조정 프로토콜",descEn:"Agent team design and coordination protocols"},{path:"/build",icon:"fa-hammer",nameKo:"직접 구축",nameEn:"Build",descKo:"처음부터 Harness를 직접 구축해보기",descEn:"Build your own Harness from scratch"}],i=[{id:"webdev",ko:"웹 개발 팀",en:"Web Dev Team"},{id:"content",ko:"콘텐츠 제작",en:"Content Creation"},{id:"review",ko:"코드 리뷰",en:"Code Review"},{id:"abtest",ko:"A/B 테스트",en:"A/B Testing"},{id:"strategy",ko:"도입 전략",en:"Adoption Strategy"},{id:"measure",ko:"성과 측정",en:"Performance Measurement"}],g=[{label:"팀 구성 사례",labelEn:"Team Examples",items:[{id:"webdev",icon:"fa-globe",ko:"웹 개발 팀",en:"Web Dev Team"},{id:"content",icon:"fa-pen-nib",ko:"콘텐츠 제작",en:"Content Creation"}]},{label:"품질 & 측정",labelEn:"Quality & Metrics",items:[{id:"review",icon:"fa-code-compare",ko:"코드 리뷰",en:"Code Review"},{id:"abtest",icon:"fa-chart-bar",ko:"A/B 테스트",en:"A/B Testing"}]},{label:"도입 전략",labelEn:"Adoption",items:[{id:"strategy",icon:"fa-chess-king",ko:"도입 전략",en:"Adoption Strategy"},{id:"measure",icon:"fa-chart-line",ko:"성과 측정",en:"Performance Measurement"}]}];function E(){const{language:s}=o(),[c,l]=h.useState("webdev"),n=s==="ko",a=i.findIndex(d=>d.id===c),t=d=>{l(d),window.scrollTo({top:0,behavior:"smooth"})};return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:n?"실전 활용 | Harness Master":"Real-world Practice | Harness Master",path:"/practice"}),e.jsxs("div",{className:"guide-page",children:[e.jsx(j,{items:[{label:"실전활용",labelEn:"Practice"}]}),e.jsxs("div",{className:"guide-layout",children:[e.jsx(x,{groups:g,activeSection:c,onNavigate:t,isKo:n}),e.jsxs("main",{className:"guide-content",children:[e.jsx("div",{className:"guide-pdf-btn-wrapper",children:e.jsxs("button",{className:"guide-pdf-btn",onClick:()=>window.print(),title:n?"PDF로 저장":"Save as PDF",children:[e.jsx("i",{className:"fa-solid fa-file-pdf"}),n?"PDF 저장":"Save PDF"]})}),c==="webdev"&&e.jsx(f,{isKo:n}),c==="content"&&e.jsx(N,{isKo:n}),c==="review"&&e.jsx(b,{isKo:n}),c==="abtest"&&e.jsx(y,{isKo:n}),c==="strategy"&&e.jsx(k,{isKo:n}),c==="measure"&&e.jsx(w,{isKo:n}),e.jsx(p,{pageId:"practice"}),e.jsx(u,{guides:v}),e.jsxs("div",{className:"guide-section-nav",children:[e.jsxs("button",{className:"guide-nav-btn prev",onClick:()=>t(i[a-1].id),disabled:a===0,children:[e.jsx("i",{className:"fa-solid fa-arrow-left"}),e.jsxs("span",{children:[e.jsx("small",{children:n?"이전":"Prev"}),e.jsx("strong",{children:a>0?n?i[a-1].ko:i[a-1].en:""})]})]}),e.jsxs("button",{className:"guide-nav-btn next",onClick:()=>t(i[a+1].id),disabled:a===i.length-1,children:[e.jsxs("span",{children:[e.jsx("small",{children:n?"다음":"Next"}),e.jsx("strong",{children:a<i.length-1?n?i[a+1].ko:i[a+1].en:""})]}),e.jsx("i",{className:"fa-solid fa-arrow-right"})]})]})]})]})]})]})}function f({isKo:s}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:s?"웹 개발 팀 구성":"Web Development Team"}),e.jsx("p",{children:s?"Harness로 완전한 웹 개발 에이전트 팀을 구성하고 운영하는 방법을 실전 예시로 배웁니다.":"Learn through real examples how to build and operate a complete web development agent team with Harness."})]}),e.jsx("h2",{children:s?"추천 팀 구성":"Recommended Team Composition"}),e.jsxs("div",{className:"info-grid",children:[e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🏗️"}),e.jsx("div",{className:"info-card-title",children:s?"아키텍트 에이전트 (Opus)":"Architect Agent (Opus)"}),e.jsx("div",{className:"info-card-desc",children:s?"전체 시스템 설계, 기술 스택 결정, 아키텍처 문서 작성. 고비용이지만 핵심 결정에만 사용.":"Full system design, tech stack decisions, architecture documentation. Expensive but used only for key decisions."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🎨"}),e.jsx("div",{className:"info-card-title",children:s?"개발 에이전트 (Sonnet) ×2":"Dev Agent (Sonnet) ×2"}),e.jsx("div",{className:"info-card-desc",children:s?"실제 코드 구현. 두 개를 병렬로 실행하여 프론트/백엔드를 동시에 개발.":"Actual code implementation. Run two in parallel for simultaneous front/backend development."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🔍"}),e.jsx("div",{className:"info-card-title",children:s?"리뷰어 에이전트 (Sonnet)":"Reviewer Agent (Sonnet)"}),e.jsx("div",{className:"info-card-desc",children:s?"코드 품질, 보안 취약점, 성능 이슈 검토. 모든 PR에 의무 적용.":"Code quality, security vulnerability, performance issue review. Mandatory for all PRs."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🧪"}),e.jsx("div",{className:"info-card-title",children:s?"테스터 에이전트 (Haiku)":"Tester Agent (Haiku)"}),e.jsx("div",{className:"info-card-desc",children:s?"단위/통합 테스트 자동 생성 및 실행. 저비용 모델로도 충분.":"Automatic unit/integration test generation and execution. Low-cost model sufficient."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🚀"}),e.jsx("div",{className:"info-card-title",children:s?"배포 에이전트 (Haiku)":"Deploy Agent (Haiku)"}),e.jsx("div",{className:"info-card-desc",children:s?"CI/CD 파이프라인 관리, 배포 스크립트 실행.":"CI/CD pipeline management, deployment script execution."})]})]}),e.jsx("h2",{children:s?"워크플로우":"Workflow"}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"text"}),e.jsx("span",{className:"code-block-filename",children:s?"웹 개발팀 워크플로우":"Web Dev Team Workflow"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`요구사항(Input)
       │
       ▼
┌──────────────────┐
...
}`})})})]}),e.jsx(r,{type:"warning",children:s?"한 번에 모든 것을 바꾸려 하지 마세요. 점진적 도입이 성공률이 높습니다. 첫 번째 프로젝트에서 완벽한 Harness 활용을 목표로 삼지 말고, 배우고 개선하는 과정으로 여기세요.":"Don't try to change everything at once. Gradual adoption has a higher success rate. Don't aim for perfect Harness usage on the first project; treat it as a learning and improvement process."}),e.jsx("h2",{children:s?"Solo Agent vs 3-Agent Harness 비교":"Solo Agent vs 3-Agent Harness Comparison"}),e.jsx("p",{children:s?"Anthropic의 풀스택 앱 개발 실험 결과입니다. 동일한 요구사항을 Solo(단일 AI)와 3-Agent(Planner→Generator→Evaluator)로 각각 처리했습니다.":"Results from Anthropic's full-stack app development experiment. The same requirements were processed by Solo (single AI) and 3-Agent (Planner→Generator→Evaluator)."}),e.jsx("div",{className:"comparison-table-wrapper",children:e.jsxs("table",{className:"comparison-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:s?"항목":"Item"}),e.jsx("th",{children:"Solo Agent"}),e.jsx("th",{children:"3-Agent Harness"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:s?"소요 시간":"Time"}),e.jsxs("td",{children:["20",s?"분":"min"]}),e.jsxs("td",{children:["6",s?"시간":"hrs"]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:s?"비용":"Cost"}),e.jsx("td",{children:"$9"}),e.jsx("td",{children:"$200"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:s?"외형":"Appearance"}),e.jsx("td",{children:s?"그럴듯함":"Looks polished"}),e.jsx("td",{children:s?"프로덕션급":"Production-grade"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:s?"핵심 기능":"Core Features"}),e.jsx("td",{children:s?"미작동":"Non-functional"}),e.jsx("td",{children:s?"16개 모두 정상":"All 16 working"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:s?"실제 사용 가능?":"Actually usable?"}),e.jsx("td",{children:e.jsx("strong",{children:"❌"})}),e.jsx("td",{children:e.jsx("strong",{children:"✅"})})]})]})]})}),e.jsx(r,{type:"danger",children:s?'비용이 20배 차이나지만, Solo는 실질적으로 쓸 수 없는 결과물입니다. "싸고 빠르게 만들었지만 작동하지 않는 앱"은 비용이 0원인 것과 같습니다. — Anthropic Engineering Blog':`Cost differs 20x, but Solo produces unusable results. "A cheap, fast app that doesn't work" costs the same as nothing. — Anthropic Engineering Blog`}),e.jsx("h2",{children:s?"Sprint Contract (완료 기준 사전 합의)":"Sprint Contract (Pre-agreed Completion Criteria)"}),e.jsx("p",{children:s?'코딩을 시작하기 전에 Generator와 Evaluator가 "이번 스프린트의 목표"와 "합격 기준"을 먼저 정의합니다. 건설 현장의 시공사-감리사 관계와 동일한 원리입니다.':`Before coding begins, the Generator and Evaluator first define "this sprint's goals" and "acceptance criteria." The same principle as the contractor-inspector relationship in construction.`}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"json"}),e.jsx("span",{className:"code-block-filename",children:"sprint-contract.json"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`{
  "sprint": 3,
  "goal": "사용자 인증 시스템 구현",
  "acceptance_criteria": [
    "이메일/비밀번호 로그인 작동",
...
}`})})})]}),e.jsx("h2",{children:s?"Anthropic의 3대 핵심 교훈":"Anthropic's 3 Core Lessons"}),e.jsxs("div",{className:"info-grid",children:[e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"👁️"}),e.jsx("h4",{children:s?"모델을 직접 관찰하라":"Observe the Model Directly"}),e.jsx("p",{children:s?"추측하지 말고 AI의 실제 작동 과정을 읽고 분석하세요. 원하는 결과가 나올 때까지 반복 튜닝하는 것이 핵심입니다.":"Don't guess — read and analyze the AI's actual process. The key is iterative tuning until desired results emerge."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"✂️"}),e.jsx("h4",{children:s?"복잡한 작업은 분해·전문화하라":"Decompose & Specialize Complex Tasks"}),e.jsx("p",{children:s?"하나의 AI에게 모든 역할을 부여하지 마세요. 기획/개발/검수처럼 역할별 전문 에이전트를 두면 성능이 크게 향상됩니다.":"Don't assign all roles to one AI. Performance greatly improves with specialized agents for planning/development/QA."})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"🔄"}),e.jsx("h4",{children:s?"새 모델 출시 시 하네스를 재점검하라":"Re-examine Harness on New Model Release"}),e.jsx("p",{children:s?'하네스의 모든 구성요소는 "모델이 혼자 못 하는 것"에 대한 가정입니다. 불필요해진 것은 빼고, 새로 가능해진 것을 위한 요소를 추가하세요.':`Every harness component assumes "what the model can't do alone." Remove what's no longer needed and add components for newly possible capabilities.`})]})]}),e.jsx("h3",{children:s?"모델 업그레이드 시 하네스 진화 사례":"Harness Evolution on Model Upgrade"}),e.jsx("p",{children:s?"Opus 4.5 → 4.6 업그레이드 시 Anthropic은 기존 하네스에서 3가지를 제거할 수 있었습니다.":"When upgrading from Opus 4.5 → 4.6, Anthropic was able to remove 3 things from the existing harness."}),e.jsx("div",{className:"comparison-table-wrapper",children:e.jsxs("table",{className:"comparison-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:s?"제거된 구성요소":"Removed Component"}),e.jsx("th",{children:s?"이유":"Reason"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:s?"스프린트 분할":"Sprint splitting"}),e.jsx("td",{children:s?"4.6은 2시간 이상 연속 작업 가능":"4.6 can work continuously for 2+ hours"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"Context Reset"}),e.jsx("td",{children:s?"컨텍스트 불안이 크게 감소":"Context Anxiety greatly reduced"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:s?"중간 QA":"Intermediate QA"}),e.jsx("td",{children:s?"매 스프린트 검수 → 최종 QA만으로 충분":"Per-sprint review → final QA only is sufficient"})]})]})]})}),e.jsx(r,{type:"important",children:s?'"흥미로운 하네스 조합의 공간은 모델이 발전해도 줄어들지 않는다. 이동할 뿐이다." — AI 기술은 프롬프트 엔지니어링에서 하네스 엔지니어링으로 진화하고 있습니다.':`"The space of interesting harness compositions doesn't shrink as models improve — it just moves." — AI technology is evolving from prompt engineering to harness engineering.`})]})}function w({isKo:s}){return e.jsxs("div",{className:"guide-section",children:[e.jsxs("div",{className:"guide-content-header",children:[e.jsx("h1",{children:s?"성과 측정":"Performance Measurement"}),e.jsx("p",{children:s?"Harness 도입의 성과를 객관적으로 측정하고 지속 개선하는 방법을 배웁니다.":"Learn how to objectively measure the results of Harness adoption and continuously improve."})]}),e.jsx("h2",{children:s?"핵심 성과 지표(KPI)":"Key Performance Indicators (KPIs)"}),e.jsxs("div",{className:"info-grid",children:[e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"⚡"}),e.jsx("div",{className:"info-card-title",children:s?"생산성 지표":"Productivity Metrics"}),e.jsx("div",{className:"info-card-desc",children:s?"작업당 평균 처리 시간, 일일 완료 작업 수, 반복 작업 자동화율":"Average processing time per task, daily completed tasks, repetitive task automation rate"})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"✅"}),e.jsx("div",{className:"info-card-title",children:s?"품질 지표":"Quality Metrics"}),e.jsx("div",{className:"info-card-desc",children:s?"코드 리뷰 통과율, 버그 발생률, 고객 만족도":"Code review pass rate, bug occurrence rate, customer satisfaction"})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"💰"}),e.jsx("div",{className:"info-card-title",children:s?"비용 지표":"Cost Metrics"}),e.jsx("div",{className:"info-card-desc",children:s?"API 호출 비용, 모델별 비용 배분, ROI":"API call cost, cost distribution by model, ROI"})]}),e.jsxs("div",{className:"info-card",children:[e.jsx("div",{className:"info-card-icon",children:"📖"}),e.jsx("div",{className:"info-card-title",children:s?"학습 지표":"Learning Metrics"}),e.jsx("div",{className:"info-card-desc",children:s?"스킬 재사용률, 팀 만족도, 온보딩 시간":"Skill reuse rate, team satisfaction, onboarding time"})]})]}),e.jsx("h3",{children:s?"KPI 추적 파일 예시":"KPI Tracking File Example"}),e.jsx("p",{children:s?"오케스트레이터가 매 스프린트 종료 후 자동으로 업데이트하는 KPI 추적 파일입니다.":"A KPI tracking file the orchestrator automatically updates after each sprint."}),e.jsxs("div",{className:"code-block",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:"json"}),e.jsx("span",{className:"code-block-filename",children:"tmp/kpi-report.json"})]}),e.jsx("div",{className:"code-block-body",children:e.jsx("pre",{children:e.jsx("code",{children:`{
